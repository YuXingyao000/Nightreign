...
Goal.Activate = function (f2_arg0, f2_arg1, f2_arg2)
    ...
    -- basicblock_170
    f2_local0[1] = SetCoolTime(f2_arg1, f2_arg2, 3000, 10, f2_local0[1], 1) -- 1阶段
    f2_local0[2] = SetCoolTime(f2_arg1, f2_arg2, 3001, 20, f2_local0[2], 1) -- 1阶段
    f2_local0[3] = SetCoolTime(f2_arg1, f2_arg2, 3005, 20, f2_local0[3], 1) -- 1阶段
    f2_local0[3] = SetCoolTime(f2_arg1, f2_arg2, 3010, 20, f2_local0[3], 1) -- 1阶段
    f2_local0[4] = SetCoolTime(f2_arg1, f2_arg2, 3012, 20, f2_local0[4], 1) -- 1阶段
    f2_local0[5] = SetCoolTime(f2_arg1, f2_arg2, 3013, 10, f2_local0[5], 1) -- 1阶段
    f2_local0[13] = SetCoolTime(f2_arg1, f2_arg2, 3018, 5, f2_local0[13], 1) -- 1阶段，红刀走位拉近特用
    f2_local0[14] = SetCoolTime(f2_arg1, f2_arg2, 3024, 30, f2_local0[14], 1) -- 1阶段，乱舞
    f2_local0[15] = SetCoolTime(f2_arg1, f2_arg2, 3025, 20, f2_local0[15], 1) -- 1阶段 吸球
    f2_local0[18] = SetCoolTime(f2_arg1, f2_arg2, 3032, 0, f2_local0[18], 1) -- 什么鬼，FS竟然没删这行代码
    f2_local0[18] = SetCoolTime(f2_arg1, f2_arg2, 3025, 20, f2_local0[18], 1) -- 2阶段 吸球
    f2_local0[20] = SetCoolTime(f2_arg1, f2_arg2, 3000, 10, f2_local0[20], 1) -- 2阶段
    f2_local0[21] = SetCoolTime(f2_arg1, f2_arg2, 3001, 20, f2_local0[21], 1) -- 2阶段
    f2_local0[22] = SetCoolTime(f2_arg1, f2_arg2, 3005, 20, f2_local0[22], 1) -- 2阶段
    f2_local0[22] = SetCoolTime(f2_arg1, f2_arg2, 3010, 20, f2_local0[22], 1) -- 2阶段
    f2_local0[23] = SetCoolTime(f2_arg1, f2_arg2, 3012, 20, f2_local0[23], 1) -- 2阶段
    f2_local0[24] = SetCoolTime(f2_arg1, f2_arg2, 3013, 10, f2_local0[24], 1) -- 2阶段
    f2_local0[35] = SetCoolTime(f2_arg1, f2_arg2, 3020, 20, f2_local0[35], 1) -- 2阶段，左走位甩出尸块
    f2_local0[35] = SetCoolTime(f2_arg1, f2_arg2, 3021, 20, f2_local0[35], 1) -- 2阶段，右走位甩出尸块
    f2_local0[35] = SetCoolTime(f2_arg1, f2_arg2, 6002, 20, f2_local0[35], 1) -- 2阶段，向左走位
    f2_local0[35] = SetCoolTime(f2_arg1, f2_arg2, 6003, 20, f2_local0[35], 1) -- 2阶段，向右走位
    f2_local0[36] = SetCoolTime(f2_arg1, f2_arg2, 3022, 40, f2_local0[36], 1) -- 2阶段，乱舞
    f2_local0[37] = SetCoolTime(f2_arg1, f2_arg2, 3034, 30, f2_local0[37], 1) -- 2阶段，高处飞扑
    f2_local0[45] = SetCoolTime(f2_arg1, f2_arg2, 6002, 20, f2_local0[45], 1) -- 2阶段，向左走位
    f2_local0[45] = SetCoolTime(f2_arg1, f2_arg2, 6003, 20, f2_local0[45], 1) -- 2阶段，向右走位
    f2_local0[45] = SetCoolTime(f2_arg1, f2_arg2, 3020, 20, f2_local0[45], 1) -- 2阶段，甩出尸块
    f2_local0[45] = SetCoolTime(f2_arg1, f2_arg2, 3021, 20, f2_local0[45], 1) -- 2阶段，甩出尸块
    f2_local1[1] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act01) -- 1阶段 5980 5039 5025effect 注意上面序号和函数内local8的对应，上面的似乎是冷却时间，动画是能根据编号对应上的
    f2_local1[2] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act02) -- 1阶段 5980 5039 5026effect
    f2_local1[3] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act03) -- 1阶段 5980 5039 5027effect
    f2_local1[4] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act04) -- 1阶段 5980 5039 5030effect
    f2_local1[5] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act05) -- 1阶段 5980 5039 5031effect
    f2_local1[10] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act10) -- 1阶段 红刀抬手 5039 60580
    f2_local1[11] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act11) -- 1阶段 红刀架势 
    f2_local1[12] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act12) -- 1阶段 红刀释放 60552 60570
    f2_local1[13] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act13) -- 1阶段 红刀走位拉近
    f2_local1[14] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act14) -- 1阶段 乱舞 5980 5039
    f2_local1[15] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act15) -- 1阶段 吸球 5980 5039 60527 60566 二阶段会在此基础上多一个 60593
    f2_local1[16] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act16) -- 吸球后原地释放1次 5980 5039 60527 60571
    f2_local1[17] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act17) -- 吸球后原地释放2次 5980 5039 60527 60571 60530
    f2_local1[18] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act18) -- 超大球 5108 5980 5039 60513 60527 60547 60550 二阶段会在此基础上多一个 60593
    f2_local1[20] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act20) -- 似乎是二阶段的动作了
    f2_local1[21] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act21) -- 同上动画序号对应的effect相同，只是二阶段动画不一样，但是似乎资产编号一样
    f2_local1[22] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act22) -- 同上动画序号对应的effect相同
    f2_local1[23] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act23) -- 同上动画序号对应的effect相同
    f2_local1[24] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act24) -- 同上动画序号对应的effect相同
    f2_local1[30] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act30) -- 二阶段红刀   60565 60567 60580
    f2_local1[31] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act31) -- 二阶段红刀架势 5980 5039 60527 60565 
    f2_local1[32] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act32) -- 二阶段红刀释放 5980 5039 60527 60552 60570
    f2_local1[35] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act35) -- 二阶段向右位移甩出尸块 5980 5039 5033
    f2_local1[36] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act36) -- 吼叫，危险攻击的起手动画，有一个5034effect被加上了 以及 5980 5039 60580
    f2_local1[37] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act37) -- 飞扑，有一个5035effect被加上了 5980 5039 60527 60516
    f2_local1[38] = REGIST_FUNC(f2_arg1, f2_arg2, KingOfRubble761000_Act38) -- 长吼叫，更危险动作起手动画，有一个5037effect被加上了  5980 5039 60527 60513  60545
